    ...
    <div class="container p-0">
      ...
      <div class=" collapse navbar-collapse " id="navbarNavDropdown">
        <ul class="navbar-nav mx-auto ">
          ...
          <li class="nav-item ">
            <a class="nav-link mx-3 <?php if ($_SESSION['title'] == "Profile") {
              echo "active";
            } ?>"
          ...
          <li class="nav-item">
            <a class="nav-link mx-3 <?php if ($_SESSION['title'] == "EVENTS") {
              echo "text-white";
            } ?>"
              href="events.php">Transaction Record</a>
          </li>


          <li class="nav-item d-none d-lg-block px-5 ">
            <a class="nav-link mx-3 img-holder <?php if ($_SESSION['title'] == "HOME") {
              echo "active`";
            } ?>"
              href="index.php">HOME
          ...
          <li class="nav-item">
            <a class="nav-link mx-3 <?php if ($_SESSION['title'] == "ELECTION") {
              echo "text-white";
            } ?>"
              href="election.php">Manage Account</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mx-3 <?php if ($_SESSION['title'] == "SERVICES") {
              echo "text-white";
            } ?>"
              href="services.php">About</a>
          </li>
          <li class="nav-item">
